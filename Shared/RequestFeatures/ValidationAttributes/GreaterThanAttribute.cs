...
namespace Shared.RequestFeatures.ValidationAttributes;
...
public sealed class GreaterThanAttribute : CompareAttribute
{
    ...
    protected override ValidationResult? IsValid(object? value, ValidationContext validationContext)
    {
        ...
        var comparerProperty = comparerType.GetProperty(nameof(Comparer<object>.Default), BindingFlags.Public | BindingFlags.Static);
